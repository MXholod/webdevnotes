        ...
        <div class="card-body overflow-auto accept_replace">
            <ul class="paths-list">
                ...
                >
                    ...
                    <input type="hidden" name="paths[]" :value="dataItem.path_js" />
                </li>
            </ul>
...
<script>
import { EventEmitterCreate } from "../../app_main_admin.js";
export default {
    props:["dbpaths"],
    data(){
        return {
    ...
    methods:{
        ...
        toFilePathsComponent:function(event){
            ...
            //Use Event Bus
            EventEmitterCreate.$emit("dataToFiles",this.dataPreparedFiles);
        },
    ...
    created(){
        ...
        //Use Event Bus
        EventEmitterCreate.$on("dataToDB",data => {
