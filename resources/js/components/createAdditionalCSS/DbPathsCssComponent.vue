        ...
        <div class="card-body overflow-auto accept_replace">
            <ul class="paths-list">
                ...
                >
                    ...
                    <input type="hidden" name="pathsCss[]" :value="dataItem.path_js" />
                </li>
            </ul>
...
export default {
    ...
    methods:{
        ...
        prepareIncomingData: function(){
            this.dbpaths.forEach((currentValue, index, array)=>{
                //Set new Reactiv property 'highlited' to the Object, initial highlited value
        ...
        toFilePathsComponent:function(event){
            ...
            //Use Event Bus
            EventEmitterCreateCss.$emit("dataToFiles",this.dataPreparedFiles);
        },
    ...
    created(){
        ...
        //Use Event Bus
        EventEmitterCreateCss.$on("dataToDB",data => {
