    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <p class="text-center">Выбрать необходимые Css файлы для этой страницы</p>
            </div>
        </div>
...
<script>
import FilePathsComponent from "./FilePathsCssComponent.vue";
import DbPathsComponent from "./DbPathsCssComponent.vue";
    export default {
